#!/usr/bin/env python3
"""Historical pre-role-cleanup WH1 controlled water-draw implementation.

Reference only. Do not run this archived copy. The active implementation lives
under ``software.commands`` and ``software.runtime``.
"""
    ...
    *,
    ...
    try:
        ...
        while volume_gal < target_vol_gal:
            ...
            if (
                any(value != value for value in temps.values())
                or ambient != ambient
                or flow != flow
            ):
